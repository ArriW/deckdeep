...
class Card:
    ...
    def generate_card_pool(num_cards: int = 3) -> List["Card"]:
        card_pool = [
            ...
            Card("Soul Drain", 3, Rarity.RARE, damage=18, health_regain=4, health_cost=10),
            ...
            Card("Overload", 3, Rarity.RARE, damage=15, health_cost=10, targets_all=True),
            ...
            Card("Ice Armor", 1, Rarity.UNCOMMON, shield=15, health_cost=4),
            ...
            Card("Fan of Knives", 1, Rarity.UNCOMMON, damage=1, targets_all=True, bleed=2),
            ...
            Card("Whirlwind", 3, Rarity.RARE, damage=2, shield=3, targets_all=True, bleed=2),
            ...
            Card("Monstrosity", 2, Rarity.UNIQUE, health_regain=5, health_cost=10, bonus_damage=4),
            Card("Retreat.", 5, Rarity.RARE, card_draw=4, shield=15),
            Card("Lightning", 4, Rarity.RARE, damage=10, bonus_damage=2, targets_all=True),
            ...
            Card("Ember Shield", 2, Rarity.UNCOMMON, shield=10, burn=1),
            Card("Rally Troops", 2, Rarity.UNCOMMON, bolster=3, card_draw=1),
            Card("Warcry", 3, Rarity.RARE, bolster=2, bonus_damage=4, targets_all=True),
...
def get_player_starting_deck() -> List[Card]:
    return [
        ...
        Card("Shield", 1, Rarity.COMMON, shield=6),
        Card("Power Strike", 2, Rarity.COMMON, damage=15),
        Card("AW's Gift", 0, Rarity.COMMON, card_draw=1, health_regain=1, healing=3),
    ]
